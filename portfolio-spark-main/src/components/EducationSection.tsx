...
const educationData: EducationItem[] = [
  {
    ...
    score: 'CGPA: 8.9/10',
    description: "Specialized in Software Engineering, AI-integrated web development, and full-stack application design, with hands-on experience building intelligent systems including an AI-based Health Assistant as a capstone project.",
    icon: '🎓',
  },
  {
    year: '2020 - 2022',
