...
const Scene = () => {
  return (
    <>
      ...
      {/* Floating geometries */}
      <FloatingGeometry position={[-3, 2, -2]} color="#00d4ff" speed={0.8} />
      <FloatingGeometry position={[3, -1, -3]} color="#7c3aed" speed={1.2} />
      <FloatingGeometry position={[-2, -2, -4]} color="#00d4ff" speed={1} />
      <FloatingGeometry position={[4, 1, -5]} color="#7c3aed" speed={0.6} />
      
      <FloatingTorus position={[2, 2, -3]} color="#00d4ff" />
      <FloatingTorus position={[-3, -1, -4]} color="#7c3aed" />
